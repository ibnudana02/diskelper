...
<!-- header -->
	<div class="header_bg">
		<div class="container">
			...
			<div class="header">
			<!--	<div class="logo">
					<a href="index.html"><img src="images/logo1.png"  style="float:center"  alt=" " /></a>
				</div> -->
				<nav class="navbar navbar-default">
					...
					<div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
						<ul class="nav navbar-nav">
							...
							<li class="act"><a href="profil.html">Profil</a></li>
							</ul>
					</div><!-- /.navbar-collapse -->	
							...
							<li>
								<div class="banner-info">
									<div class="dummy_text">
										<h1>WebGis Kementerian Lingkungan Hidup dan Kehutanan merupakan situs data dan informasi</h1>
										</h1>
									</div>
								</div>
							</li>
